...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=1\textwidth]{min_sum_tree_0.pdf}
	...
	$G_2$ setzt sich insgesamtaus 2 disjunkten Bäumen zusammen - deren Kanten mit unterschiedlicher Stärke dargestellt sind - und ist so in die Ebene eingebettet, dass jeder Knoten von $G_1$ genau 2 gültige $\varepsilon$-Platzierung hat aus
	den entsprechenden Teilgraphen hat von $G_2$ hat. Es ist leicht zu sehen, dass jede Knoten-Platzierung (schwach) gültig ist.}
\end{figure}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.6\textwidth]{chapter_4_example.pdf}
    \caption{TODO: Schreibe Caption, ergänze Bezeichnungen}
\end{figure}
