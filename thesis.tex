...
Geometrische Graphen eignen sich dadurch insbesondere zur Darstellung von Netzwerken wie beispielsweise Straßennetzen.
In diesem Sinne wollen geometrische Graphen miteinander vergleichen, um im Anwendungsfall Aussagen über die Güte der durch den Graphen gegebenen Repräsentation des Netzwerkes treffen zu können.
\\
Zum Vergleich zweier eingebetteter Graphen stößt man in der Literatur auf das Konzept des Abstandsmaßes zwischen Graphen.
