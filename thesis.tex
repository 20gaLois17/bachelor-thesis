...
Graphen, denen eine konkrete Darstellung ihrer Knoten und Kanten - z.B im euklidischen Raum - zugewiesen wurde, bezeichnen wir als eingebettete Graphen.
Bekannte Vertreter dieser Klasse sind die planaren Graphen. Dies sind  Graphen, deren deren Kanten sich als Jordan-Kurven so in die euklidische
Ebene einbetten lassen, dass sie sich untereinander nur in ihren inzidenten Knoten schneiden.
\\
\\
...
\begin{Def} \label{Definition Fréchet-Abstand}
	...
	Da der Fréchet-Abstand insbesondere symmetrisch ist (TODO: Referenz), spielt es keine Rolle, ob wir $f$ oder $g$ reparametrisieren.
	\\
