...
Graphen, denen eine konkrete Darstellung ihrer Knoten und Kanten - zum Beispielim euklidischen Raum - zugewiesen wird, bezeichnen wir als eingebettete Graphen.
\\
\\
...
Geometrische Graphen eignen sich insbesondere zur Repräsentation von Netzwerken wie zum Beispiel Straßennetzen.
\\
...
Unter einem Abstandsmaß verstehen im Allgemeinen eine reellwertige Zuordung zum Vergleich zweier geometrischer Objekte wie zum Beispiel zum Vergleich von zwei Kurven im euklidischen Raum.
Für den Vergleich von eingebetteten Graphen existieren dabei bereits einige bekannte Abstandsmaße.
\\
Einige Abstandsmaße erfassen zum Beispiel beim Vergleich von eingebetteten Graphen lediglich die Repräsentation der Graphen im Sinne ihrer Punktmenge im euklidischen Raum berücksichtigen dabei nicht die ihnen
...
In Kapitel 2 fassen wir dazu zunächst die Notation und die zentralen Begriffe aus \cite{Akitaya} zusammen, welche den Grundstein für die Auseinandersetzung mit dem neuen Abstandsmaß bilden.
In Kapitel 3 werden wir ein weiteres Abstandsmaß auf Graphen motivieren und einführen. Anschließend werden wir uns mit den Bedingungen und einem Ansatz beschäftigen, um dieses Abstandsmaß
in Polynomialzeit berechnen zu können.
Abschließend beschäftigen wir uns in Kapitel 4 mit der Komplexität des besagten Maßes für allgemeine Graphen.
\newpage
...
\begin{Def} \label{Definition Fréchet-Abstand}
	...
	\\
\end{Def}
Wir möchten an dieser Stelle einige wichtige Bemerkungen zu den Eigenschaften des (schwachen) Fréchet-Abstands machen.
TODO: Hier sollten wir ergänzen, dass wir den Fréchet-Abstand bei ebenen Kurven "erkennen" können.
...
\begin{Def}
	...
	\\
	\\
	Für die Komplexität dieser Klasse von Entscheidungsproblemen siehe auch \cite{Karp}.
\end{Def}
