...
In der Definition des Min-Sum-Graph-Abstands$_{(w)F}(G_1, G_2)$ ziehen wir stets alle Graph-Abbildungen $s: G_1 \to G_2$ in Betracht.

Die Menge aller Graph-Abbildungen zwischen $G_1$ und $G_2$ werden wir mit zwei Einschränkungen versehen.
Die erste Einschränkung ist dabei optional und die zweite Einschränkung ist notwendig für die Polynomialzeit des Algorithmus.
\\
\\
...
Entsprechend soll der in blau gezeichnete Graph auf den in rot gezeichneten Graphen abgebildet werden.
\\
\\
