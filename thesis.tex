...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/frechet_example.pdf}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/chapter_2_example_1.pdf}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/chapter_2_example_0.pdf}
...
\begin{Def}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[width=0.8\textwidth]{assets/chapter_3_placements_example.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/chapter_3_example_0.pdf}
...
\begin{figure}[H]
	\includegraphics[width=\textwidth]{assets/min_sum_tree_0.pdf}
	\caption{
...
\begin{figure}[H]
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{assets/min_sum_tree_1.pdf}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{assets/min_sum_tree_2.pdf}
	\end{subfigure}
	\caption{
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{assets/min_sum_tree_h_0.pdf}
	\caption{
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{assets/min_sum_tree_h_1.pdf}
	\caption{
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{assets/chapter_4_construction.pdf}
	\caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/chapter_4_example_0.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/chapter_4_example_1.pdf}
    \caption{
